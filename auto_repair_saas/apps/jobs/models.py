...
class Job(models.Model):
    ...
    vehicle = models.ForeignKey(Vehicle, on_delete=models.RESTRICT, related_name='vehicle')
    ...
    status = models.CharField(choices=status_type_choices, max_length=15, null=False, blank=False, default='pending')
